...
//!
//! The symbols in this module is part of visioniechor's public API, but are generally
...
/// # Example
/// ```
/// use visioniechor::disjoint_sets::group_by_cached_key;
...
/// # Example
/// ```
/// use visioniechor::disjoint_sets::group_by;
/// let points = vec![1,1,7,9,24,1,4,7,3,8];
